...
# #### Step 16 - Implementing an image color detector which identifies all the color in an image and video.
...
while True:
    ...
    if clicked:
        cv2.qwrectangle(img, (20,20), (600,60), (b,g,r), -1)
...
# 
# Also I have used csv file for image color detector.
